...
This part is modified based on the lecture note, [Single Cell RNA-Seq - Introduction](http://data-science-sequencing.github.io/Win2018/lectures/lecture16/) created by David Tse et.al.
...
```{r biasedreads2, fig.cap='Grouping barcodes to assign reads to cells(David Tse et.al)', out.width='70%', fig.align='center', echo=FALSE}
knitr::include_graphics('./figs/biasedreads2.png')
```

Analysis of the cell barcode and UMI is included in the alignment process, and we will introduce more in Chapter \@ref(raw2matrix).
